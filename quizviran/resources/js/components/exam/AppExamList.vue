    ...
    <div class="w-100">
        ...
        <table class="text-center table table-responsive-sm table-responsive-lg table-responsive-md table-striped">
            <tr>
                ...
                <td><span class="fas fa-recycle"></span> <span>خروجی</span></td>
            </tr>
            ...
            <tr v-if="exams.length" v-for="(exam,index) in examList" :class="[exam.show ? 'bg-info' : 'bg-dark-gray']">
                ...
                <td><a class="btn btn-sm dark-shadow btn-light text-dark" @click="switchToEditMode(exam)">ویرایش</a>
                </td>
                ...
                <td>
                    <button class="btn btn-warning btn-sm dark-shadow" @click.prevent="revival({exam:exam,sub:''})">
                        تمدید
                    </button>
                    <button class="btn btn-secondary btn-sm dark-shadow"
                            @click.prevent="revival({exam:exam,sub:'sub'})">کاهش
                    </button>
                </td>
                <td>
                ...
                <td><a class="btn btn-sm dark-shadow btn-light" :href="exam.pdf">PDF</a></td>
            </tr>
